...
#include "javatests/com/jnibind/android/object_test_helper_jni.h"
#include "jni_bind.h"
...
JNIEXPORT void JNICALL Java_com_jnibind_android_ArrayTest_nativeBooleanTests(

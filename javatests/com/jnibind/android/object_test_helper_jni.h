...
constexpr jni::Class kObjectTestHelperClass {
    "com/jnibind/android/ObjectTestHelper",
    ...
    jni::Method{"returnNewObjectWithFieldSetToSum",
      jni::Overload{
        jni::Return{jni::Class{"com/jnibind/android/ObjectTestHelper"}},
        jni::Params<int, int>{}
      },
      jni::Overload{
        jni::Return{jni::Class{"com/jnibind/android/ObjectTestHelper"}},
        jni::Params{jni::Class{"com/jnibind/android/ObjectTestHelper"}}
      },
    },

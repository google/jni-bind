 ...
 */
#ifndef JNI_BIND_METAPROGRAMMING_DEEP_EQUAL_DIMINISHED_H_
#define JNI_BIND_METAPROGRAMMING_DEEP_EQUAL_DIMINISHED_H_
...
#endif  // JNI_BIND_METAPROGRAMMING_DEEP_EQUAL_DIMINISHED_H_

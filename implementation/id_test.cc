...
// Class.
////////////////////////////////////////////////////////////////////////////////
using ClassIdT = Id<JT, IdType::CLASS, kNoIdx, kNoIdx, kNoIdx, 0>;
...
// Constructors
////////////////////////////////////////////////////////////////////////////////
using kCtor0 = Id<JT, IdType::OVERLOAD, kNoIdx, 0, kNoIdx, 0>;
using kCtor1 = Id<JT, IdType::OVERLOAD, kNoIdx, 1, kNoIdx, 0>;
using kCtor2 = Id<JT, IdType::OVERLOAD, kNoIdx, 2, kNoIdx, 0>;
using kCtor3 = Id<JT, IdType::OVERLOAD, kNoIdx, 3, kNoIdx, 0>;
using kCtor4 = Id<JT, IdType::OVERLOAD, kNoIdx, 4, kNoIdx, 0>;
...
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, kNoIdx, 1, 0, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, kNoIdx, 2, 0, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, kNoIdx, 2, 0, 0>::kRank);
static_assert(1 == Id<JT, IdType::OVERLOAD_PARAM, kNoIdx, 3, 0, 0>::kRank);

////////////////////////////////////////////////////////////////////////////////
// Methods (Overload sets with only one overload)
////////////////////////////////////////////////////////////////////////////////
using kMethod0 = Id<JT, IdType::OVERLOAD_SET, 0, kNoIdx, kNoIdx, 0>;
using kMethod1 = Id<JT, IdType::OVERLOAD_SET, 1, kNoIdx, kNoIdx, 0>;
using kMethod2 = Id<JT, IdType::OVERLOAD_SET, 2, kNoIdx, kNoIdx, 0>;
using kMethod3 = Id<JT, IdType::OVERLOAD_SET, 3, kNoIdx, kNoIdx, 0>;
using kMethod4 = Id<JT, IdType::OVERLOAD_SET, 4, kNoIdx, kNoIdx, 0>;
using kMethod5 = Id<JT, IdType::OVERLOAD_SET, 5, kNoIdx, kNoIdx, 0>;
using kMethod6 = Id<JT, IdType::OVERLOAD_SET, 6, kNoIdx, kNoIdx, 0>;
using kMethod7 = Id<JT, IdType::OVERLOAD_SET, 7, kNoIdx, kNoIdx, 0>;
...
using kMethod0Overload0 = Id<JT, IdType::OVERLOAD, 0, 0, kNoIdx, 0>;
using kMethod1Overload0 = Id<JT, IdType::OVERLOAD, 1, 0, kNoIdx, 0>;
using kMethod2Overload0 = Id<JT, IdType::OVERLOAD, 2, 0, kNoIdx, 0>;
using kMethod3Overload0 = Id<JT, IdType::OVERLOAD, 3, 0, kNoIdx, 0>;
using kMethod5Overload0 = Id<JT, IdType::OVERLOAD, 5, 0, kNoIdx, 0>;
using kMethod6Overload0 = Id<JT, IdType::OVERLOAD, 6, 0, kNoIdx, 0>;
using kMethod7Overload0 = Id<JT, IdType::OVERLOAD, 7, 0, kNoIdx, 0>;
...
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, 0, 0, kNoIdx, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, 1, 0, kNoIdx, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, 1, 0, 0, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, 2, 0, 0, 0>::kRank);
static_assert(0 == Id<JT, IdType::OVERLOAD_PARAM, 2, 0, 1, 0>::kRank);

////////////////////////////////////////////////////////////////////////////////
// Overloaded Method (smoke test, they should behave the same).
////////////////////////////////////////////////////////////////////////////////
using kMethod3Overload0 = Id<JT, IdType::OVERLOAD, 3, 0, kNoIdx, 0>;
using kMethod3Overload1 = Id<JT, IdType::OVERLOAD, 3, 1, kNoIdx, 0>;
using kMethod3Overload2 = Id<JT, IdType::OVERLOAD, 3, 2, kNoIdx, 0>;

using kMethod4Overload0 = Id<JT, IdType::OVERLOAD, 4, 0, kNoIdx, 0>;
using kMethod4Overload1 = Id<JT, IdType::OVERLOAD, 4, 1, kNoIdx, 0>;
using kMethod4Overload2 = Id<JT, IdType::OVERLOAD, 4, 2, kNoIdx, 0>;
...
using kMethod4Overload0Return = Id<JT, IdType::OVERLOAD_PARAM, 4, 0, kNoIdx, 0>;
using kMethod4Overload0Param0 = Id<JT, IdType::OVERLOAD_PARAM, 4, 0, 0, 0>;

using kMethod4Overload1Return = Id<JT, IdType::OVERLOAD_PARAM, 4, 1, kNoIdx, 0>;
using kMethod4Overload1Param0 = Id<JT, IdType::OVERLOAD_PARAM, 4, 1, 0, 0>;

using kMethod4Overload2Return = Id<JT, IdType::OVERLOAD_PARAM, 4, 2, kNoIdx, 0>;
using kMethod4Overload2Param0 = Id<JT, IdType::OVERLOAD_PARAM, 4, 2, 0, 0>;
...
using kMethod5Overload0Return = Id<JT, IdType::OVERLOAD_PARAM, 5, 0, kNoIdx, 0>;
using kMethod5Overload0Param0 = Id<JT, IdType::OVERLOAD_PARAM, 5, 0, kNoIdx, 0>;
using kMethod6Overload0Return = Id<JT, IdType::OVERLOAD_PARAM, 6, 0, kNoIdx, 0>;
using kMethod6Overload0Param0 = Id<JT, IdType::OVERLOAD_PARAM, 6, 0, kNoIdx, 0>;
...
using kMethod7Overload0Return = Id<JT, IdType::OVERLOAD_PARAM, 7, 0, kNoIdx, 0>;
...
////////////////////////////////////////////////////////////////////////////////
using kField0 = Id<JT, IdType::FIELD, 0, kNoIdx, kNoIdx, 0>;
using kField1 = Id<JT, IdType::FIELD, 1, kNoIdx, kNoIdx, 0>;
...
// Static Methods.
////////////////////////////////////////////////////////////////////////////////
using kStaticMethod0 =
    Id<JTS, IdType::STATIC_OVERLOAD_SET, 0, kNoIdx, kNoIdx, 0>;
using kStaticMethod1 =
    Id<JTS, IdType::STATIC_OVERLOAD_SET, 1, kNoIdx, kNoIdx, 0>;
using kStaticMethod2 =
    Id<JTS, IdType::STATIC_OVERLOAD_SET, 2, kNoIdx, kNoIdx, 0>;
using kStaticMethod3 =
    Id<JTS, IdType::STATIC_OVERLOAD_SET, 3, kNoIdx, kNoIdx, 0>;
...
using kStaticMethod0Overload0 =
    Id<JTS, IdType::STATIC_OVERLOAD, 0, 0, kNoIdx, 0>;
using kStaticMethod1Overload0 =
    Id<JTS, IdType::STATIC_OVERLOAD, 1, 0, kNoIdx, 0>;
using kStaticMethod2Overload0 =
    Id<JTS, IdType::STATIC_OVERLOAD, 2, 0, kNoIdx, 0>;
using kStaticMethod3Overload0 =
    Id<JTS, IdType::STATIC_OVERLOAD, 3, 0, kNoIdx, 0>;
...
static_assert(0 ==
              Id<JTS, IdType::STATIC_OVERLOAD_PARAM, 0, 0, kNoIdx, 0>::kRank);
static_assert(0 ==
              Id<JTS, IdType::STATIC_OVERLOAD_PARAM, 1, 0, kNoIdx, 0>::kRank);
static_assert(0 == Id<JTS, IdType::STATIC_OVERLOAD_PARAM, 1, 0, 0, 0>::kRank);
static_assert(0 == Id<JTS, IdType::STATIC_OVERLOAD_PARAM, 2, 0, 0, 0>::kRank);
static_assert(0 == Id<JTS, IdType::STATIC_OVERLOAD_PARAM, 2, 0, 1, 0>::kRank);

////////////////////////////////////////////////////////////////////////////////
// Static Fields.
////////////////////////////////////////////////////////////////////////////////
using kStaticField0 = Id<JTS, IdType::STATIC_FIELD, 0, kNoIdx, kNoIdx, 0>;
using kStaticField1 = Id<JTS, IdType::STATIC_FIELD, 1, kNoIdx, kNoIdx, 0>;
using kStaticField2 = Id<JTS, IdType::STATIC_FIELD, 2, kNoIdx, kNoIdx, 0>;
using kStaticField3 = Id<JTS, IdType::STATIC_FIELD, 3, kNoIdx, kNoIdx, 0>;
